<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="{{ route('home') }}">
              <div class="d-flex align-items-center"><img class="me-2" src="{{ asset('assets/img/icons/spot-illustrations/falcon.png') }}" alt="" width="40" /><span class="font-sans-serif text-primary">falcon</span>
              </div>
            </a>
...
{{ auth()->user()->name }}
                    ...
                    <a class="dropdown-item" href="{{ url('pages/user/profile.html') }}">Profile &amp; account</a>

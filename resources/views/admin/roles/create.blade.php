...
@section('cms-main-content')
    <div class="container-fluid mt-2">
        ...
        <form action="{{ route('roles.store') }}" method="POST">
            @csrf
            <x-falcon.card title="Create New Role" bodyClass="p-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <x-falcon.form-group label="Role Name" name="name" required="true" helpText="Unique identifier for the role.">
                            <input type="text" name="name" id="roleName" class="form-control shadow-none" placeholder="e.g. Manager" required>
                        </x-falcon.form-group>
                    </div>
                </div>
            </x-falcon.card>

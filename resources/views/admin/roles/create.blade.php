                    ...
                    <div class="col-sm-auto d-flex align-items-center"><img class="ms-n2"
                        ...
                        <div>
                            ...
                            <h4 class="text-primary fw-bold mb-0">
                                Create New Role
                                <span class="text-danger fw-medium"> - </span><span class="text-info fw-medium"> Permissions
                                    Assignment</span>
                            </h4>
                        </div>
                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="name" id="roleName" class="form-control" placeholder="e.g. Manager"
                            required>
        ...
        <div class="card mb-3">
            ...
            <div class="card-footer bg-light text-end">
                <button type="submit" class="btn btn-primary px-5">
                    <span class="fas fa-save me-1"></span> Save New Role
                </button>
            </div>
        </div>
    </form>

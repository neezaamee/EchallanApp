...
<div class="container py-4">
    ...
    <div class="row g-3">
        <div class="col-md-3">
      <a href="{{ route('admin.provinces') }}" class="card text-center p-4 hover:bg-light">
                <h5 class="fw-bold">Provinces</h5>
                <p class="text-muted small">Manage all provinces</p>
            </a>
        </div>
        <div class="col-md-3">
      <a href="{{ route('admin.cities') }}" class="card text-center p-4 hover:bg-light">
                <h5 class="fw-bold">Cities</h5>
                <p class="text-muted small">Manage cities by province</p>
            </a>
        </div>
        <div class="col-md-3">
      <a href="{{ route('admin.circles') }}" class="card text-center p-4 hover:bg-light">
                <h5 class="fw-bold">Circles</h5>
                <p class="text-muted small">Assign circles to cities</p>
            </a>
        </div>
        <div class="col-md-3">
      <a href="{{ route('admin.medical-centers') }}" class="card text-center p-4 hover:bg-light">

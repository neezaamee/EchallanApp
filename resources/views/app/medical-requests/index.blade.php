    ...
    <div class="row align-items-center mb-4">
        ...
        <div class="col-md-6 text-end">
             <div class="d-flex justify-content-end gap-2">
                 <form action="{{ route('medical-requests.index') }}" method="GET" class="d-flex gap-2">
                     <input type="text" name="search" class="form-control" placeholder="Search PSID, Name, CNIC" value="{{ request('search') }}">
                     <button type="submit" class="btn btn-primary"><i class="bi bi-search"></i></button>
                     @if(request('search'))
                        <a href="{{ route('medical-requests.index') }}" class="btn btn-secondary" title="Clear Search"><i class="bi bi-x-lg"></i></a>
                     @endif
                 </form>
                @role('citizen')
                    <a href="{{ route('medical-requests.create') }}" class="btn btn-success">

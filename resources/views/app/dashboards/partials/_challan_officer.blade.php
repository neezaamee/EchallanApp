...
<div class="row">
    <div class="col-12">
        <x-falcon.card title="Officer Operations" bodyClass="p-4" headerClass="bg-light">
            <p class="card-text text-800 fs--1">Manage your traffic enforcement operations here. You can issue new challans and track payment statuses by using the buttons below or the sidebar menu.</p>
            <div class="mt-3">

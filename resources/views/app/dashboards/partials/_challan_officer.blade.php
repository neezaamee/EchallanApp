...
<div class="row">
    <div class="col-12">
        <div class="card bg-soft-info border-info">
            <div class="card-body">
                <h5 class="card-title text-info">Officer Operations</h5>
                <p class="card-text">Manage your traffic enforcement operations here. You can issue new challans and track payment statuses by using the buttons below or the sidebar menu.</p>
                <div class="mt-3">
